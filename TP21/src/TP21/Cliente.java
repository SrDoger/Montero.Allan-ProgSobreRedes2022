...
public class Cliente extends Persona{
    ...
    public Cliente(DataBase lista, int dni, String nombre, String apellido, String numContacto) {
        super(dni, nombre, apellido, numContacto);
        this.usuarios = lista;
    }

    public DataBase getUsuarios() {
        return usuarios;
    }

    public void setUsuarios(DataBase usuarios) {
